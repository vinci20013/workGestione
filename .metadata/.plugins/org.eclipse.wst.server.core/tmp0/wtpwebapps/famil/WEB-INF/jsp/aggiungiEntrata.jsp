...
<td width="6px"></td>
<td width="200px">
<h4 align="left"><b>Aggiungi nuova Entrata</b></h4>
</td>
</tr>
</table>
...
<form name="MioForm" method="post" action="inserisciEntrata.htm">
...
<table align="center" border="1">
      ...
      <select class="anno" name="anno" >
		...
		<td>&nbsp;&nbsp;<input name="importo" type= "text" value="" size="27"/></td>
    	</tr>
        ...
        <option value="Stipendio" <%if(tipologia.equals("")){%>selected="selected"<% } %>>Stipendio</option>
        <option value="Rimborso" <%if(tipologia.equals("Gas")){%>selected="selected"<% } %>>Rimborso</option>
		...
		<td>&nbsp;&nbsp;<input name="descrizione" type="text" value="" size="27"/></td>
    	</tr> 
    	...
    	<p align="center">&nbsp;</p>  
  		<table align="center" border="0">
	   	<tr>	 	  	
		   <td><a href="#" onclick="submitForm();" class="aButton"><img width="35" height="35" alt="Salva" src="images/salva.png" title="Salva" border="0"></a>
